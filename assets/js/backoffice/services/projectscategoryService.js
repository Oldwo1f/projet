app.factory('projectscategoryService', ['$http','$q',function ($http,$q) {
    var service = {};
    service.categories=[];
    ...
    // {id:3,'category':'Energie Future',status:'Inactif','title' :'477title category projects','content':'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam iste dolorum sint facere quos corporis, quo ducimus explicabo dolorem at mollitia sequi, enim? Eius ab quisquam, non quia, laudantium qui.'},
